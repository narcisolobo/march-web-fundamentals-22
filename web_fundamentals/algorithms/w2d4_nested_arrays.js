...
1. isPresent2d
Write a function called isPresent2d(arr2d, value) that returns true if the value is present and false otherwise. Note - Don't assume the array will always be the same size, we must rely on its .length property. Hint - Can we put a for loop inside another for loop? Answer - YES
